...
const TYPE_MAP = {
  ...
  [Sequelize.UUID.name]: {type: 'string', format: 'uuid'},
  [Sequelize.UUIDV1.name]: {type: 'string', format: 'uuid', description: 'UUID v1'},
  [Sequelize.UUIDV4.name]: {type: 'string', format: 'uuid', description: 'UUID v4'},
  [Sequelize.ENUM.name]: {type: 'string', description: 'enum'},
  /** date types */
