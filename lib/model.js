  ...
  model.getModelAssociations = function () {
    ...
    this.getAssociatedModelNames().forEach(associationName => {
      ...
      if (association.associationType === 'BelongsToMany') {
        //console.log(require('util').inspect(association, {customInspect: false}))
      }
      switch (association.associationType) {
        ...
        case 'BelongsToMany':
          return result.push({
            source, target, associationType: association.associationType, through: association.throughModel,
